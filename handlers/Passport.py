...
from TornadoProject.handlers.BaseHandler import BaseHandler
...
#         password = hashlib.sha256(config.passwd_hash_key + password).haxdigest()
#         try:
#             res = self.db.ex
